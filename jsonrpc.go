...
func rpcResetEDID() error {
	...
	logger.Info().Str("current_edid", currentEDID).Msg("Resetting EDID by switching to 1080p temporary EDID and back")

	// Temporary EDID for reset (DELL D2721H - 1920x1080)
	const temp1080pEDID = ""

	// Step 1: Switch to temporary 1080p EDID
	logger.Info().Str("temp_edid", temp1080pEDID).Msg("Switching to temporary 1080p EDID (DELL D2721H)")
	err = nativeInstance.VideoSetEDID(temp1080pEDID)
	if err != nil {
